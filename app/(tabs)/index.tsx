...
const Brainstorm = () => {
  ...
  return (
    <SafeAreaView style={style}>
      ...
      <Button icon="camera" mode="outlined" onPress={handleFetch}>Get Entries</Button>
      <Button icon="camera" mode="contained" onPress={handleSubmit}>Submit Entry</Button>
      {todoList.map((todo, i) => (<ThemedText key={i}>{todo.body}</ThemedText>))}
    </SafeAreaView>
  )
}
